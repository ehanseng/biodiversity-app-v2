      ...
      <ScrollView ref={scrollViewRef} style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.row}>
              <TextInput style={[styles.input, {flex: 1, marginRight: 5}]} value={formData.latitude} placeholder="Latitud" keyboardType="numeric" />
              <TextInput style={[styles.input, {flex: 1, marginLeft: 5}]} value={formData.longitude} placeholder="Longitud" keyboardType="numeric" />
          </View>
